...
# we used Exchange IKE DH with 8192 bits in size to be used for cryptographic operation.
...
def create_dh_key():
    ...
    a = random.randint(0, int(2**32)) # Our_private key
    A= pow(g,a,prime ) # Our pubilc key
    return (A, a)

def calculate_dh_secret(their_public, a):
    # Calculate the shared secret
    shared_secret = pow(their_public, a, prime)
